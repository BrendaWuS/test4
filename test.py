...
# 所有权限令牌token
token = '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'
# 创建Github对象
g = Github(token)
...
# 创建Github对象
g = Github(base_url="https://api.github.com", login_or_token="2976037599@qq.com", private_key_path="8~/.ssh/id_ed25519")
